...
"CLOUD_KEY" "CLOUD_SECRET" "USERS_DB" "SALT" "JWT_SECRET" "TEST" 
"PAYPAL_CLIENT_SECRET" "PAYPAL_CLIENT_ID" "PRODUCTION" "WEBSITE_URL")
...
heroku addons:create heroku-redis:$REDIS_PLAN
$SET_CONFIGS